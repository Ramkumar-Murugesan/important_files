...
app.controller("campaign-controller", [
		'$scope',
		'$log',
		'$location',
		'$http',
		...
		function($scope, $log, $location, $http, $timeout, $routeParams,
			...
			$scope.addNewCampaign = function() {
				...
				$location.url('/campaigns-en/create');
			};
			
			$scope.gotoSendEmail = function() {
				$location.url('/campaigns-en/sendemail/send');
			};
			...
			$scope.editExistingCampaign = function(id) {
				...
				$location.url('/campaigns-en/update');
			};
